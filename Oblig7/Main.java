...
//       Labyrint myLab = Labyrint.lesFraFil(inFile);
//       System.out.println(myLab);
//       //myLab.grid[0][1].finnUtvei(myLab.grid[0][1]);
//       System.out.println(myLab.finnUtveiFra(3,5));
//       System.out.println(myLab.finnUtveiFra(11,9));
//     }
//     catch (FileNotFoundException e) {
